...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneGenerator : MonoBehaviour
    {
        ...
        private List<GameObject> m_NewPlanes_visible = new List<GameObject>();
        ...
        public void VisiblePlane(bool visible)
        {
        ...
        public void Update()
        {
            ...
            for (int i = 0; i < m_NewPlanes.Count; i++)
            {
                ...
                m_NewPlanes_visible.Add(planeObject);

            }
            foreach (GameObject plane in m_NewPlanes_visible)
                plane.SendMessage("Hide_pointCloud", visible);
        }
    }
}
